    ...
    <div className="bg-zinc-900 rounded-xl p-4 space-y-4 mt-4">
      ...
      <div className="pt-2">
        <button
          ...
          className="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-6 rounded-xl w-full transition-colors shadow-lg"
        >
          ✅ Send Selected Files
        </button>
      </div>
      ...
      >
        ...
        <div
          className={`absolute top-2 w-2 h-2 transform rotate-45 ${
            isUser ? "bg-green-600 right-[-4px]" : "bg-zinc-800 left-[-4px]"
          }`}
        ></div>
      </div>
